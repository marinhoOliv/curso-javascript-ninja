...
var mod = calculator( '%' );
var testError = calculator( '|' );

/*
Faça uma operação com cada uma das funções criadas acima, mostrando o resultado
no console.
*/
console.log(substraction(7500, 4459));
console.log(multiplication(8, 8));
console.log(division(1250,2));
console.log(mod(1250, 2));
console.log(testError(4,5));